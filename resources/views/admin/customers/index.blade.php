				...
				<div class="row">
					<div class="col-12">
						<div class="text-right">
							<a href="{{ route('customer.create') }}" class="btn btn-primary">Agregar</a>
						</div>
							...
							<table class="table table-hover table-export">
								...
								<tbody>
									...
									<tr>
										...
										<td>{!! typeUser($customer->type) !!}</td>
										<td>{!! state($customer->state) !!}</td>
										<td>
											<div class="btn-group" role="group">
												<a href="{{ route('customer.show', ['slug' => $customer->slug]) }}" class="btn btn-primary btn-sm bs-tooltip" title="Perfil"><i class="fa fa-user"></i></a>
												<a href="{{ route('customer.edit', ['slug' => $customer->slug]) }}" class="btn btn-info btn-sm bs-tooltip" title="Editar"><i class="fa fa-edit"></i></a>
												@if($customer->state==1)
