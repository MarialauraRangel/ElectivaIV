			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('category.update', ['slug' => $category->slug]) }}" method="POST" class="form" id="formAdministrator" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input class="form-control" type="text" name="description" required placeholder="Teléfono" value="{{ $category->description }}" id="description">
								</div>
