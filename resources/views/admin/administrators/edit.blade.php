						...
						<form action="{{ route('administradores.update', ['slug' => $admin->slug]) }}" method="POST" class="form" id="formAdministrator" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									<div class="row">
										<div class="form-group col-lg-12 col-md-12 col-12">
											...
											<input class="form-control" type="text" name="name" required placeholder="Nombres" value="{{ $admin->name }}" id="name">
										</div>

										<div class="form-group col-lg-12 col-md-12 col-12">
											<label class="col-form-label">Apellido<b class="text-danger">*</b></label>
											<input class="form-control" type="text" name="lastname" required placeholder="Apellidos" value="{{ $admin->lastname }}" id="lastname">
										</div>
									</div> 
								</div>
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input class="form-control" type="text" name="phone" required placeholder="Teléfono" value="{{ $admin->phone }}" id="phone">
								</div>
